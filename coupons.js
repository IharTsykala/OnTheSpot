...
jQuery('tr.order-total bdi:last')
...
jQuery('[name="apply_coupon"]')
jQuery('.total .right')

jQuery('[class="basket-summary__discount__link "]')[0].click()
jQuery('[class="order-summary__discount__link "]')[0].click()
jQuery('input[id="js-discount-code-input"]:first')
jQuery('button[id="js-discount-button"]:first')
jQuery('.table__row--total .table__data')
